...
@Tag(name = "Autenticação", description = "Endpoint para autenticação de administradores") // NOVO: Agrupa os endpoints
public class AuthController {

    @Autowired
    private AuthService authService;

    @Operation(summary = "Realiza o login de um administrador e retorna um token JWT") // NOVO: Descrição da operação
    @ApiResponses(value = { // NOVO: Descreve as possíveis respostas
